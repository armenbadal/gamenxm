...
Առայժմ ես ուզում եմ գլխավոր պատուհանի մենյուների տողում ունենալ երկու մենյու․ «Խաղ» և «Հուշում»։ Առաջինում լինելու է երկու գործողություն․ «Նոր», որը սկսում է նոր խաղ, և «Ելք», որն ավարտում է ծրագրի աշխատանքը։ «Հուշում» մենյուն ունենալու է միյան մեկ կետ՝ «Տեղեկություն», որը տեղեկություն է տալու ծրագրի մասին։
...
{
    QString text = "<b>Խաղ N×M</b> - 2015";
    QMessageBox::about(this, "Խաղ N×M", text);
}
````

Հիմա մենյուների մասին։ Ծրագրի մենյուների տողը `QMenuBar` տիպի օբյեկտ է, իսկ «Խաղ» և «Հուշում» մենյուները՝ `QMenu` տիպի։ `Window` դասում հայտարարեմ համապատասխան ցուցիչները․
